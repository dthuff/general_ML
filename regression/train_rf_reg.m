function [ pred, Mdl ] = train_rf_reg( features, labels, cv_folds )
%Trains a Support Vector Machine model on data features with classes labels.
...
%             struct('AcquisitionFunctionName','expected-improvement-plus'));
        ...
        [predicted_test_labels, ~] = predict(Mdl, features_test);
...
%% store useful things in output structs
    ...
    pred.cv_labels_dict = cv_true_label_dict;
    pred.cv_predictions_dict = cv_pred_label_dict;
